...
public class ErgoKeysPlugin implements ApplicationComponent {
    ...
    private final ActionBinding[] bindings = {
            ...
            new ActionBinding("EditorSelectWord", KeyEvent.VK_1, KeyEvent.VK_AMPERSAND),
            new ActionBinding("EditorSelectLine", KeyEvent.VK_2, KeyEvent.VK_OPEN_BRACKET),
            new ActionBinding("UnsplitAll", KeyEvent.VK_3, KeyEvent.VK_BRACELEFT),
            new ActionBinding("SplitVertically", KeyEvent.VK_4, KeyEvent.VK_BRACERIGHT),
            new ActionBinding("$Delete", KeyEvent.VK_5, KeyEvent.VK_LEFT_PARENTHESIS),
            new ActionBinding("EditorSelectLine", KeyEvent.VK_7, KeyEvent.VK_MULTIPLY),
            new ActionBinding("EditorSelectWord", KeyEvent.VK_8, KeyEvent.VK_RIGHT_PARENTHESIS),
            new ActionBinding("ErgoKeysSelectString", KeyEvent.VK_9, KeyEvent.VK_PLUS),
